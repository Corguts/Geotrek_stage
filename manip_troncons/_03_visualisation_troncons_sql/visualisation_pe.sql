...
WHERE ct.kind = 'TREK' 
  AND tt.name LIKE 'PE %' -- () si besoin de spécifier un PE en particulier mettre un espace est les 2 noms bien séparés par un tiret à la place du pourcentage entre les simples guillemets, pensez à nommer les PE de cette manière au début
